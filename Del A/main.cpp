...
// Destruktor, används för att frigöra minne, men det finns inget behov för det, eftersom vi inte har något dynamiskt allokerat minne för detta program
Transaktion::~Transaktion()
{
...
// Destruktor som inte används som sagt
PersonLista::~PersonLista()
{

}

// Lägger till en ny person om listan inte är full, är listan full så skrivs ett felmeddelande ut i stället
void PersonLista::laggTill(Person ny_person)
{
    // Kollar om listan är full
    if (antal_personer < MAX_PERSONER)
        {
            // Finns det plats läggs den nya personen till och antalet personer ökar med ett
            personer[antal_personer] = ny_person;
            antal_personer++;
        }
    // Är listan full så skickas ett felmeddelande
    else
        {
            cout << "Maximalt antal personer har redan lagts till." << endl;
        }
}
...
// Lägger till en transaktion till en lista, är listan full så skrivs ett felmeddelande ut i stället
void TransaktionsLista::laggTill(Transaktion & t)
{
    if (antal_transaktioner < MAX_TRANSAKTIONER)
        ...
        {
            cout << "Maximalt antal transaktioner har redan lagts till." << endl;
        }
}
    ...
    for (int i = 0; i < antal_transaktioner; i++)
        {
            ...
            // Kolar om personen med det specifika namnet finns i listan
